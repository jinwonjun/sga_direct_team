...
Cubeman_Left_leg::Cubeman_Left_leg() : m_rotY(0.0f), RotY(0.0f)
, m_moveSpeed(0.1f), m_vPosition(0, 0, 0)
{
}


Cubeman_Left_leg::~Cubeman_Left_leg()
{
}

void Cubeman_Left_leg::Init()
{
