...
Cubeman_Right_arm::Cubeman_Right_arm() : m_rotY(0.0f), RotY(0.0f)
, m_moveSpeed(0.1f), m_vPosition(0, 0, 0)
{
}


Cubeman_Right_arm::~Cubeman_Right_arm()
{
}

void Cubeman_Right_arm::Init()
{
